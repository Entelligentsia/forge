...
When `/forge:rebuild` or `/forge:update` encounters a file that the user has modified, it shows a diff and asks what to keep. This prevents Forge from overwriting custom work.
