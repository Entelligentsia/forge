...
| `type-mismatch` | `iter: "1"` instead of `1` | Yes |
...
## Related commands
- [`/forge:search`](search.md) — search the store
- [`/forge:health`](health.md) — detect store integrity issues
