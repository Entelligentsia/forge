 ...
 */
export function buildVersionDriftMsg(configPath, bundledVersion) {
    try {
        if (!bundledVersion)
            return null;
        ...
        if (projectVersion === bundledVersion)
            return null;
        if (projectVersion < bundledVersion) {
            return (`△ Project was initialized with Forge ${projectVersion} but the installed binary bundles ${bundledVersion}. ` +
