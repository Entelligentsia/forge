 ...
 */
export function checkTwoLayerBoundary(targetPath, cwd) {
    ...
    return {
        ...
        reason: "forge-cli runtime cannot write to forge/forge/meta/ — fix the bug in " +
            "forge-engineer/forge-bugfixer skill against forge/ instead. " +
            `(resolved: ${resolved})`,
    };
}
//# sourceMappingURL=two-layer-guard.js.map