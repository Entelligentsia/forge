...
export function parseGuardArgs(rawArgs) {
 ...
 * in the allowed set.
 */
export function runPipelineGuard(phase, taskId, forgeRoot, cwd) {
    const allowed = { blocked: false, message: "" };
