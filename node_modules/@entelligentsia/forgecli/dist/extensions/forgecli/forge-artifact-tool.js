...
export function buildForgeArtifact(projectRoot, _engineeringPath, toolDir, _runCjsOverride) {
    ...
    return {
        ...
        description: "Read, write, or list phase artifacts (PLAN.md, PROGRESS.md, *-SUMMARY.json, etc.) " +
        ...
        async execute(_toolCallId, _params, signal) {
            ...
            let tmpFile = null;
            try {
                const argv = [params.command, params.entity, params.entityId];
...
//# sourceMappingURL=forge-artifact-tool.js.map