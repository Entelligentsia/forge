...
let cachedTomoshibiPrompt = null;
function resetTomoshibiState() {
...
function outsideProjectNoOp(commandName, ctx) {
...
async function delegateMarkdownCommand(pi, forgeRoot, commandName, args, ctx) {
...
export function registerForgeCommands(pi, options) {
    ...
    pi.registerCommand("forge:health", {
        ...
        async handler(args, ctx) {
            if (!forgeRoot)
                return outsideProjectNoOp("health", ctx);
            ...
            if (hasFix) {
                ...
                const syntheticPi = {
                    ...
                    registerCommand: (name, def) => {
                        if (name === "forge:calibrate")
                            calibrateHandler = def.handler;
                    },
                };
