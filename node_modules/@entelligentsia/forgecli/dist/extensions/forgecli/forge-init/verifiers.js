...
function resolveVerifyPhaseTool(cwd) {
...
async function runVerifyPhase(cwd, args) {
 ...
 */
export async function verifyPhase1(cwd) {
 ...
 */
export async function verifyPhase1Foundation(cwd) {
 ...
 */
export async function verifyPhase2(cwd, kbPath) {
 ...
 */
export async function verifyPhase3(cwd) {
