 ...
 */
export function detectFoundryCollision() {
    try {
...
function seenJsonPath() {
    return path.join(getUserCacheDir(), "seen.json");
}
function readSeenJson() {
    try {
 ...
 */
export function wasCollisionSeen(colliderPath) {
    try {
 ...
 */
export function markCollisionSeen(colliderPath) {
    try {
...
//# sourceMappingURL=foundry-collision.js.map