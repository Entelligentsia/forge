...
export const TIERS = ["heavy", "standard", "light"];
...
export const PHASE_PERSONA_TABLE = [
 ...
 */
export function tierPersonaLine(tier) {
    return TIER_PERSONAS[tier]
        .map((p) => {
...
//# sourceMappingURL=tier-meta.js.map