...
async function readAvailableModels(sessionRegistry) {
    ...
    try {
        const available = registry.getAvailable().map((m) => ({ provider: m.provider, id: m.id }));
...
async function buildInitOptions(cwd, sessionRegistry) {
