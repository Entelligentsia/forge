...
export class TierMenuScreen {
    render(state, width, theme) {
        ...
        for (let i = 0; i < TIERS.length; i++) {
            ...
            const valueStr = tierScoped.status === "set"
    ...
    handleInput(data, state) {
        ...
        if (matchesKey(data, "1"))
            return { kind: "dispatch", action: { kind: "select-tier", tier: "heavy" } };
        if (matchesKey(data, "2"))
            return { kind: "dispatch", action: { kind: "select-tier", tier: "standard" } };
        if (matchesKey(data, "3"))
            return { kind: "dispatch", action: { kind: "select-tier", tier: "light" } };
...
//# sourceMappingURL=tier-menu.js.map