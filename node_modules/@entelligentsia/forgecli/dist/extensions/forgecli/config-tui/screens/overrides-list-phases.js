...
export class OverridesListPhasesScreen {
    render(state, width, theme) {
        ...
        lines.push("");
        lines.push(`    ${muted("#", theme)}  ${muted(padRight("ROLE", 13), theme)} ${muted(padRight("PERSONA", 13), theme)} ${muted(padRight("OVERRIDE", 25), theme)} ${muted(padRight("RESOLVED", 25), theme)} ${muted("SOURCE", theme)}`);
...
//# sourceMappingURL=overrides-list-phases.js.map