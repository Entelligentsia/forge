...
import { clearPhaseOverride, deletePersonaEntry, writePersonaEntry, writePhaseOverride, writeTierAssignment, } from "./buffer.js";
    ...
    switch (action.kind) {
        ...
        case "cursor-move": {
            ...
            if (top.kind === "tier-menu" ||
                ...
                const replaced = { ...top, cursor: newCursor };
        ...
        case "set-search": {
            ...
            if (top.kind === "tier-picker" || top.kind === "persona-editor" || top.kind === "override-editor") {
                const replaced = { ...top, searchQuery: action.query, cursor: 0 };
                return { ...state, view: [...state.view.slice(0, -1), replaced] };
            }
            return state;
        }
        ...
        case "commit-tier-model": {
            const entry = { provider: action.provider, model: action.model };
        ...
        case "commit-persona-edit": {
            ...
            if (top.kind !== "persona-editor")
                return state;
            if (!top.provider || !top.model)
                return state;
            const entry = { provider: top.provider, model: top.model };
        ...
        case "set-override-step": {
            ...
            if (top.kind !== "override-editor")
                return state;
            const updated = { ...top, step: action.step, cursor: 0, searchQuery: "" };
            return { ...state, view: [...state.view.slice(0, -1), updated] };
        }
