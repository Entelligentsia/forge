...
class ForgeHeaderContainer extends Container {
    tui;
    loader;
    builtInHeader;
    done = false;
    constructor(tui, theme, versions) {
        super();
        this.tui = tui;
        // ── Loading state ──────────────────────────────────────────────────────
        this.loader = new Loader(tui, (s) => theme.bold(theme.fg("accent", s)), (s) => "  " + theme.fg("muted", s), "kindling forge", { frames: SPINNER_FRAMES, intervalMs: 80 });
        // ── Static state ───────────────────────────────────────────────────────
        ...
        this.builtInHeader = new ExpandableText(() => `${logoBlock}\n${compactInstructions}\n${compactOnboarding}\n\n${onboarding}`, () => `${logoBlock}\n${expandedInstructions}\n\n${onboarding}`, false, 1, 0);
...
//# sourceMappingURL=forge-header.js.map