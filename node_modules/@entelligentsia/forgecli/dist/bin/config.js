...
import { ensureForgeCliPathsReady, getGlobalConfigPath, getProjectConfigPath, shortenPath, } from "../extensions/forgecli/paths/paths.js";
...
export async function runConfigShow(opts, cwd, write) {
    ...
    const hasPersonaModels = merged._global?.["persona-models"] !== undefined || merged._project?.["persona-models"] !== undefined;
