...
|---------|------|--------|---------|
| 0.17.1 | 2026-04-19 | [scan-v0.17.1.md](docs/security/scan-v0.17.1.md) | 158 files — 0 critical, 1 warning, 2 info — SAFE TO USE |
| 0.17.0 | 2026-04-19 | [scan-v0.17.0.md](docs/security/scan-v0.17.0.md) | 156 files — 0 critical, 0 warnings, 3 info — SAFE TO USE |
