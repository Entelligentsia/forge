...
|---------|------|--------|---------|
| 0.9.5 | 2026-04-15 | [scan-v0.9.5.md](docs/security/scan-v0.9.5.md) | 106 files — 0 critical, 1 warning, 2 info — SAFE TO USE |
| 0.9.4 | 2026-04-15 | [scan-v0.9.4.md](docs/security/scan-v0.9.4.md) | 106 files — 0 critical, 2 warnings (carry-forward, accepted), 14 info — SAFE TO USE |
| 0.9.3 | 2026-04-15 | [scan-v0.9.3.md](docs/security/scan-v0.9.3.md) | 106 files — 0 critical, 2 warnings (carry-forward, accepted), 14 info — SAFE TO USE |
| 0.9.2 | 2026-04-15 | [scan-v0.9.2.md](docs/security/scan-v0.9.2.md) | 106 files — 0 critical, 2 warnings (carry-forward, accepted), 14 info — SAFE TO USE |
| 0.9.1 | 2026-04-15 | [scan-v0.9.1.md](docs/security/scan-v0.9.1.md) | 106 files — 0 critical, 2 warnings (carry-forward, accepted), 14 info — SAFE TO USE |
| 0.9.0 | 2026-04-15 | [scan-v0.9.0.md](docs/security/scan-v0.9.0.md) | 105 files — 0 critical, 2 warnings (carry-forward, accepted), 5 info — SAFE TO USE |
| 0.8.3 | 2026-04-14 | [scan-v0.8.3.md](docs/security/scan-v0.8.3.md) | 102 files — 0 critical, 2 warnings (carry-forward), 4 info; path traversal fixed — SAFE TO USE |
| 0.8.2 | 2026-04-14 | [scan-v0.8.2.md](docs/security/scan-v0.8.2.md) | 102 files — 0 critical, 2 warnings (pre-existing, accepted), 5 info — SAFE TO USE |
| 0.8.1 | 2026-04-14 | [scan-v0.8.1.md](docs/security/scan-v0.8.1.md) | 102 files — 0 critical, 2 warnings (pre-existing, accepted), 3 info — SAFE TO USE |
| 0.8.0 | 2026-04-14 | [scan-v0.8.0.md](docs/security/scan-v0.8.0.md) | 102 files — 0 critical, 2 warnings (pre-existing, accepted), 3 info — SAFE TO USE |
| 0.7.11 | 2026-04-14 | [scan-v0.7.11.md](docs/security/scan-v0.7.11.md) | 102 files — 0 critical, 2 warnings (pre-existing, accepted), 3 info — SAFE TO USE |
| 0.7.10 | 2026-04-14 | [scan-v0.7.10.md](docs/security/scan-v0.7.10.md) | 102 files — 0 critical, 1 warning (pre-existing, accepted), 2 info — SAFE TO USE |
| 0.7.9 | 2026-04-14 | [scan-v0.7.9.md](docs/security/scan-v0.7.9.md) | 102 files — 0 critical, 1 warning, 2 info — SAFE TO USE |
| 0.7.8 | 2026-04-14 | [scan-v0.7.8.md](docs/security/scan-v0.7.8.md) | 95 files — 0 critical, 0 warnings, 1 info — SAFE TO USE |
| 0.7.7 | 2026-04-14 | [scan-v0.7.7.md](docs/security/scan-v0.7.7.md) | 102 files — 0 critical, 1 warning (justified), 0 info — SAFE TO USE |
| 0.7.6 | 2026-04-14 | [scan-v0.7.6.md](docs/security/scan-v0.7.6.md) | 102 files — 0 critical, 1 warning (justified), 0 info — SAFE TO USE |
| 0.7.5 | 2026-04-14 | [scan-v0.7.5.md](docs/security/scan-v0.7.5.md) | 102 files — 0 critical, 2 warnings (justified, pre-existing), 1 info — SAFE TO USE |
| 0.7.4 | 2026-04-14 | [scan-v0.7.4.md](docs/security/scan-v0.7.4.md) | 102 files — 0 critical, 2 warnings (justified), 1 info — SAFE TO USE |
| 0.7.3 | 2026-04-14 | [scan-v0.7.3.md](docs/security/scan-v0.7.3.md) | 102 files — 0 critical, 0 warnings, 2 info (all justified) — SAFE TO USE |
| 0.7.2 | 2026-04-14 | [scan-v0.7.2.md](docs/security/scan-v0.7.2.md) | 102 files — 0 critical, 0 warnings, 3 info (all justified) — SAFE TO USE |
