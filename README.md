...
|---------|------|--------|---------|
| 0.9.15 | 2026-04-16 | [scan-v0.9.15.md](docs/security/scan-v0.9.15.md) | 114 files — 0 critical, 1 warning (carry-forward), 2 info — SAFE TO USE |
| 0.9.14 | 2026-04-16 | [scan-v0.9.14.md](docs/security/scan-v0.9.14.md) | 113 files — 0 critical, 1 warning (accepted), 2 info — SAFE TO USE |
| 0.9.13 | 2026-04-16 | [scan-v0.9.13.md](docs/security/scan-v0.9.13.md) | 113 files — 0 critical, 1 warning (accepted), 2 info — SAFE TO USE |
