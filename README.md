...
|---------|------|--------|---------|
| 0.16.0 | 2026-04-19 | [scan-v0.16.0.md](docs/security/scan-v0.16.0.md) | 156 files — 0 critical, 0 warnings, 3 info — SAFE TO USE |
| 0.15.0 | 2026-04-19 | [scan-v0.15.0.md](docs/security/scan-v0.15.0.md) | 154 files — 0 critical, 0 warnings, 3 info — SAFE TO USE |
