...
docs-only repo), write a one-sentence stub: `No application stack detected — this
repository contains no build- or runtime-bearing sources.` and set confidence low.
