...
//     plugin itself (ask, health, init, migrate, regenerate, calibrate, materialize,
//     update, update-tools, add-task, add-pipeline, remove, report-bug, store-query,
//     store-repair, config). They register via the plugin's own command surface, not
