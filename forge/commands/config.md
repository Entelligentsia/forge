---
name: config
description: "[SUNSET] /forge:config is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:config — retired (Forge has moved to the CLI)
