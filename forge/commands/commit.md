---
name: commit
description: "[SUNSET] /forge:commit is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:commit — retired (Forge has moved to the CLI)
