---
name: search
description: "[SUNSET] /forge:search is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:search — retired (Forge has moved to the CLI)
