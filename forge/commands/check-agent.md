---
name: check-agent
description: "[SUNSET] /forge:check-agent is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:check-agent — retired (Forge has moved to the CLI)
