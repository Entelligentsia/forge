---
name: approve
description: "[SUNSET] /forge:approve is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:approve — retired (Forge has moved to the CLI)
