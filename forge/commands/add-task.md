---
name: add-task
description: "[SUNSET] /forge:add-task is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:add-task — retired (Forge has moved to the CLI)
