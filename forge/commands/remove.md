---
name: remove
description: "[SUNSET] /forge:remove is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:remove — retired (Forge has moved to the CLI)
