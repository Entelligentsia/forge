---
name: add-pipeline
description: "[SUNSET] /forge:add-pipeline is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:add-pipeline — retired (Forge has moved to the CLI)
