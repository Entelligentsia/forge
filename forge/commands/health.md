---
name: health
description: "[SUNSET] /forge:health is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:health — retired (Forge has moved to the CLI)
