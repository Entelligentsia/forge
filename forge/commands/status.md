---
name: status
description: "[SUNSET] /forge:status is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:status — retired (Forge has moved to the CLI)
