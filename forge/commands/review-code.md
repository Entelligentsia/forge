---
name: review-code
description: "[SUNSET] /forge:review-code is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:review-code — retired (Forge has moved to the CLI)
