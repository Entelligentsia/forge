---
name: plan-sprint
description: "[SUNSET] /forge:plan-sprint is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:plan-sprint — retired (Forge has moved to the CLI)
