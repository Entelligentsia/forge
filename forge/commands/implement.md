---
name: implement
description: "[SUNSET] /forge:implement is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:implement — retired (Forge has moved to the CLI)
