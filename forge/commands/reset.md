---
name: reset
description: "[SUNSET] /forge:reset is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:reset — retired (Forge has moved to the CLI)
