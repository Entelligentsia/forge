---
name: repair
description: "[SUNSET] /forge:repair is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:repair — retired (Forge has moved to the CLI)
