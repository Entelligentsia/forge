---
name: update
description: "[SUNSET] The Forge marketplace plugin is retired — /forge:update now migrates you to the CLI-first install."
---

# /forge:update — Forge has moved to the CLI

**The Forge marketplace plugin is being sunset.** This `/forge:update` command no
