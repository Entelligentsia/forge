---
name: review-plan
description: "[SUNSET] /forge:review-plan is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:review-plan — retired (Forge has moved to the CLI)
