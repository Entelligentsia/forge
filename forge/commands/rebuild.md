---
name: rebuild
description: "[SUNSET] The Forge marketplace plugin is retired — /forge:rebuild now migrates you to the CLI-first install."
---

# /forge:rebuild — Forge has moved to the CLI

**The Forge marketplace plugin is being sunset.** This `/forge:rebuild` command no
