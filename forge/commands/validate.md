---
name: validate
description: "[SUNSET] /forge:validate is retired in the Forge shim release — run /forge:init to migrate to the CLI."
---

# /forge:validate — retired (Forge has moved to the CLI)
